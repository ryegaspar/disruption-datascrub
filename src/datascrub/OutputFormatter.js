const address = /\d{1,5}[ ]+(?:[A-Z0-9.-]+[ ]+(?!SUITE|STE|APARTMENT|APT|ROOM|RM|BUILDING|BLDG|BLD|UNIT|PO BOX|P\.O\.[ ]BOX|#)){0,3}(?:AVE|AVENUE|BLVD|BOULEVARD|BROADWAY|CENTER|CIR|CIRCLE|COURT|CT|CTR|DR|DRIVE|EXPRESSWAY|EXPY|HIGHWAY|HWY|LANE|LN|LOOP|MALL|PATH|PARKWAY|PIKE|PL|PLACE|PLAIN|PLAZA|PLZ|PLZA|PKWY|ROAD|RD|SQ|SQUARE|STREET|ST|TPKE|TRL|TRAIL|TURNPIKE|WAY|WOODS|(?:(?:ROUTE|RT|RTE)[- ]\d{1,4}))\b(?:[ ]*(?:[NEWS]|NE|NW|SE|SW|NORTH|SOUTH|EAST|WEST)\b)?/i
