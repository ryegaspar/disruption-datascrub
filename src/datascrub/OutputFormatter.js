const address = /\d{1,5}(?:\-?\d{0,3}\-?[ABCDE])?[ ]+(?:(?:[A-Z0-9\-\.]+[ ]+)*?)+(?:AVE|AVENUE|BLVD|BOULEVARD|BROADWAY|BYP|BYPAS|BYPASS|CENTER|CIR|CIRCLE|CLB|CLUB|CMNS|CNTR|COMMON|COMMONS|CONCOURSE|CORNER|CORNERS|CORS|COURT|COVE|CRES|CRESCENT|CREST|CROSSING|CRT|CT|CTR|CURVE|CV|DR|DRIVE|E|EAST|EXPRESSWAY|EXPWY|EXPY|FREEWAY|FREEWY|FWY|GATEWAY|GTWAY|GTWY|HIGHWAY|HWY|LANE|LN|LOOP|MALL|MDW|MEADOW|MEADOWS|N|NE|NORTH|NW|PASS|PASSAGE|PATH|PARK|PARKWAY|PIKE|PK|PL|PLACE|PLAIN|PLAZA|PLZ|PLZA|PKWY|POINT|PT|ROAD|ROW|RD|RDG|RIDGE|S|SE|SOUTH|SQ|SQUARE|STREET|ST|SW|TER|TERR|TERRACE|THROUGHWAY|THRUWAY|TKPE|TPKE|TRL|TRAIL|TRACE|TRCE|TURNPIKE|VILLAGE|VIS|VISTA|VLG|W|WALK|WAY|WEST|WOODS|XING|(?:(?:INTERSTATE|ROUT|ROUTE|RT|RTE)\-?[ ]+\d{1,4}[A|B|C]?))\b/i
