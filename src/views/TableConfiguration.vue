<template>
    <div class="home">
        <div class="flex">
            ...
            <button
                class="text-gray-800 flex px-4 py-1 bg-indigo-400 rounded-lg shadow-lg border border-gray-900 hover:bg-indigo-600 mr-2 whitespace-no-wrap focus:outline-none"
